...
class CandidateFeatures:
    ...
    lineup_source: str = "unknown"
    lineup_observed_at_utc: str = ""
    candidate_pool_source: str = "unknown"
    active_roster: bool | None = None
    roster_status_code: str = ""
    ...
    starts_last_5: int = 0
    hitter_last_5_games_played: int = 0
    ...
    hitter_xba_100_pa: float | None = None
    hitter_xba_denominator_100_pa: int | None = None
    hitter_contact_xba_50_bbe: float | None = None
    hitter_hard_hit_rate_50_bbe: float | None = None
    hitter_sweet_spot_rate_50_bbe: float | None = None
    hitter_ev50_50_bbe: float | None = None
    hitter_contact_bbe_50: int | None = None
    hitter_bat_speed_50_swings: float | None = None
    hitter_swing_length_50_swings: float | None = None
    hitter_tracked_swings_50: int | None = None
    hitter_competitive_swings_season: int | None = None
    hitter_competitive_contact_rate_season: float | None = None
    hitter_avg_bat_speed_season: float | None = None
    hitter_avg_swing_length_season: float | None = None
    hitter_squared_up_per_contact_season: float | None = None
    hitter_blast_per_contact_season: float | None = None
    ...
    pitcher_xba_allowed_100_bf: float | None = None
    pitcher_xba_denominator_100_bf: int | None = None
    pitcher_contact_xba_allowed_50_bbe: float | None = None
    pitcher_hard_hit_rate_allowed_50_bbe: float | None = None
    pitcher_sweet_spot_rate_allowed_50_bbe: float | None = None
    pitcher_ev50_allowed_50_bbe: float | None = None
    pitcher_contact_bbe_50: int | None = None
    h2h_pa: int = 0
    h2h_hits: int = 0
    ...
    inferred_pitch_type_contact_rate: float | None = None
    inferred_pitch_type_shape_distance: float | None = None
    inferred_pitch_type_coverage: float | None = None
    bullpen_hpi: float | None = None
    bullpen_opp_ba: float | None = None
    bullpen_pitches_3d: int | None = None
    bullpen_relief_appearances_3d: int | None = None
    bullpen_relievers_used_3d: int | None = None
    bullpen_high_workload_relievers_3d: int | None = None
    opponent_team_oaa: float | None = None
    opponent_infield_oaa: float | None = None
    opponent_outfield_oaa: float | None = None
    feature_snapshot_id: str = ""
    feature_source_hash: str = ""
    feature_source_max_game_date: str = ""
